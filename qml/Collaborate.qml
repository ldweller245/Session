...
Page {
    ...
    Component {
        ...
        Rectangle {
            ...
            Column {
                ...
                Rectangle {width: parent.width; height: searchGrid.height
                    Grid {id: searchGrid; spacing: dp(5); anchors.horizontalCenter: parent.horizontalCenter; columns: 2
                ...
                Row {
                    width: parent.width
                    Rectangle {width: parent.width/2; height: searchButton.height
    ...
    AppListView {
        ...
        delegate: AppCard {
            ...
            header: SimpleRow {text: "Katie Prescott"; detailText: "Hairstylist, London"; enabled: false; style: StyleSimpleRow {showDisclosure: false; backgroundColor: "transparent"}}
