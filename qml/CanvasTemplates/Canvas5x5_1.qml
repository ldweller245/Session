...
Page {
    ...
    Rectangle {
        ...
        Rectangle {
            anchors.left: parent.left; anchors.top: parent.top; height: (parent.height/3)*2; width: parent.width/3; color: "white"; scale: rect1Scale; border.width: currentRect === "rect1" ? dp(5) : 0; border.color: "steelblue";
        ...
        Rectangle {
            anchors.left: parent.left; anchors.bottom: parent.bottom; height: parent.height/3; width: (parent.width/3)*2; color: "white"; scale: rect2Scale; border.width: currentRect === "rect2" ? dp(5) : 0; border.color: "steelblue";
        ...
        Rectangle {
            anchors.right: parent.right; anchors.bottom: parent.bottom; height: (parent.height/3)*2; width: parent.width/3; color: "white"; scale: rect3Scale; border.width: currentRect === "rect3" ? dp(5) : 0; border.color: "steelblue";
        ...
        Rectangle {
            anchors.right: parent.right; anchors.top: parent.top; height: parent.height/3; width: (parent.width/3)*2; color: "white"; scale: rect4Scale; border.width: currentRect === "rect4" ? dp(5) : 0; border.color: "steelblue";
        ...
        Rectangle {
            anchors.centerIn: parent; height: parent.height/3; width: parent.width/3; color: "white"; scale: rect5Scale; border.width: currentRect === "rect5" ? dp(5) : 0; border.color: "steelblue";
