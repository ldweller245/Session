    ...
    Rectangle {
        ...
        Row {
            ...
            Column {
                ...
                Rectangle {
                    height: (parent.height/3)*2; width: parent.width; color: "white"; scale: rect4Scale; border.width: currentRect === "rect4" ? dp(5) : 0; border.color: "steelblue";
            ...
            Column {
                ...
                width: parent.width/3
                Rectangle {
                    height: (parent.height/3)*2; width: parent.width; color: "white"; scale: rect2Scale; border.width: currentRect === "rect2" ? dp(5) : 0; border.color: "steelblue";
            ...
            Column {
                ...
                Rectangle {
                    height: (parent.height/3)*2; width: parent.width; color: "white"; scale: rect6Scale; border.width: currentRect === "rect6" ? dp(5) : 0; border.color: "steelblue";
