    ...
    Rectangle {
        ...
        Column {
            ...
            Row {
                ...
                Rectangle {
                    height: parent.height; width: height/2; color: "white"; scale: rect1Scale; border.width: currentRect === "rect1" ? dp(5) : 0; border.color: "steelblue";
                ...
                Rectangle {
                    height: parent.height; width: height/2; color: "white"; scale: rect2Scale; border.width: currentRect === "rect2" ? dp(5) : 0; border.color: "steelblue";
