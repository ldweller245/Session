                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        Column {
                            ...
                            AppText {id: profileName; padding: dp(10); text: "<b>"+otherUserData.firstname + "<br>" + otherUserData.surname + "</b><br>" + otherUserData.role}
                            AppText {fontSize: profileName.fontSize / 1.3; padding: dp(10); color: "grey"; text: "<b>"+otherUserData.location +"</b><br><b>Last Active:</b> " + new Date(otherUserData.lastActive).toDateString()}
                            Row{
                                width: parent.width
                    ...
                    RoundedImage  {id: profileImage; width: parent.width / 2; height: width; scale: 0.75; anchors.rightMargin: dp(10); anchors.verticalCenter: parent.verticalCenter; source: otherUserData.profile_Pic_URL; fillMode: Image.PreserveAspectCrop; radius: profileImage.width/2}
                }
            }
        }
        TabControl {
            ...
            NavigationItem {
                ...
                Item {
                    id: portfolioItem; width: userProfilePage.width; height: userProfilePage.height
                    AppFlickable {
                        contentHeight: grid.height; anchors.fill: parent
                        Grid {
                            id: grid; spacing: dp(3); width: parent.width; columns: selectedView === singleColumnButton ? 1 :2
                            Repeater {
                                id: repeater; model: 10
                                AppImage {
                                    id: postImage; fillMode: Image.PreserveAspectFit; source: modelData; width: selectedView === singleColumnButton ? parent.width : parent.width / 2
                                    MouseArea{
                                        anchors.fill: parent;
            ...
            NavigationItem {
                title: "DETAILS"
                Item {
                    width: userProfilePage.width; height: userProfilePage.height
                    AppListView {
                        anchors.fill: parent
