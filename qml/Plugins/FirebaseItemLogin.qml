...
/*/////////////////////////////////////
  ...
  Please follow the integration steps described in the plugin documentation: https://felgo.com/doc/plugin-firebase/
...
Rectangle {
    ...
    // Plugin Item - Use the FirebaseAuth Item to register and log in/log out users
    FirebaseAuth {
        id: firebaseAuth
    ...
    color: Qt.rgba(0,0,0, 0.75) // item background is translucent, we can see other items beneath this page
